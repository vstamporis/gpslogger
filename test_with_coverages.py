...
command1_monkey = "gradlew.bat clean startMonkey --events=\"2500\" --throttle=\"200\" --epochs=\"3\" --config=\"" + config1 + "\""
...
command1 = "gradlew.bat clean startBaristaFuzzer --events=\"2500\" --throttle=\"200\" --epochs=\"3\" --config=\"" + config1 + "\""
